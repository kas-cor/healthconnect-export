        ...
        Column {
                ...
                StatCard(
                    ...
                    value =
                        if (summary.avgHeartRate >
                            ...
                            "${summary.avgHeartRate.toInt()} bpm"
                        } else {
                ...
                StatCard(
                    ...
                    value =
                        if (summary.totalCalories >
                            ...
                            formatNumber(summary.totalCalories.toLong())
                        } else {
                            stringResource(R.string.dashboard_no_data)
                        },
            ...
            Row(
                ...
                StatCard(
                    ...
                    value =
                        if (summary.avgSleepMinutes >
                            0
                        ) {
                            formatMinutesToHours(summary.avgSleepMinutes)
                        } else {
                            stringResource(R.string.dashboard_no_data)
                        },
                ...
                StatCard(
                    ...
                    value =
                        if (summary.totalActiveCalories >
                            0
                        ) {
                            formatNumber(summary.totalActiveCalories.toLong())
                        } else {
                            stringResource(R.string.dashboard_no_data)
                        },
