...
- **Надёжная фоновая выгрузка** — ресивер загрузки, будильник-watchdog, работающий в Doze, и автоматическая догоняющая выгрузка пропущенных дней; журнал выгрузок во вкладке «Расписание»
